...
const String TITEL2 = "Press A to Start";                         // Titelbildschirm: Großgedruckte zweite Titelzeile
...
void zeige_startschirm_und_fuehre_menue_aus() {
  ...
  while ( warteAufStarttaste ){
    ...
    //cheungbx -  use paddle as controller for player1
...
//  arduboy.beginNoLogo();                                      // Initialisiere arduboy, aber zeige kein Logo
  ...
  power_adc_enable();    // power up ADC to allow use of paddle
 }
